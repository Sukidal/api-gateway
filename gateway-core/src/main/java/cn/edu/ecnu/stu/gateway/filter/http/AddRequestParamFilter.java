...
@FilterAspect(
        id = FilterConst.ADD_REQUEST_PARAM_FILTER_ID,
        name = FilterConst.ADD_REQUEST_PARAM_FILTER_NAME,
        order = FilterConst.ADD_REQUEST_PARAM_FILTER_ORDER
)
public class AddRequestParamFilter implements Filter {

    @Override
    public void doFilter(GatewayContext ctx) throws Exception {
        String config = ctx.getRule().getFilterConfig(FilterConst.ADD_REQUEST_PARAM_FILTER_ID).getConfig();
