...
public class GatewayRequest implements IGatewayRequest{
     ...
     * 可修改的Scheme，默认是http://
     */
    private String modifyScheme = "http://";
     ...
     */
    public GatewayRequest(String serviceId, Charset charset, String clientIp, String host, String uri, HttpMethod method, String contentType, HttpHeaders headers, FullHttpRequest fullHttpRequest) {
    ...
    public Request build() {
        requestBuilder.setUrl(redirectUrl);
